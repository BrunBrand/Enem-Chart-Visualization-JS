...
! function(t, n) {
    ...
    function et(t, n) {
        ...
        function l(l) {
            var h = null == r ? n.ticks ? n.ticks.apply(n, e) : n.domain() : r,
                ...
                A = x.select("line"),
                T = x.select("text");
            m = m.merge(m.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor")), x = x.merge(M), A = A.merge(M.append("line").attr("stroke", "currentColor").attr(f + "2", c * o)), T = T.merge(M.append("text").attr("fill", "currentColor").attr(f, c * p).attr("dy", 1 === t ? "0em" : 3 === t ? "0.71em" : "0.32em")), l !== b && (m = m.transition(l), x = x.transition(l), A = A.transition(l), T = T.transition(l), w = w.transition(l).attr("opacity", Z).attr("transform", (function(t) {
                ...
                return s(_(t))
            })), A.attr(f + "2", c * o), T.attr(f, c * p).text(d), b.filter(nt).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", 2 === t ? "start" : 4 === t ? "end" : "middle"), b.each((function() {
                this.__axis = _
            }))
        }
        return l.scale = function(t) {
            ...
            return arguments.length ? (e = null == t ? [] : $.call(t), l) : e.slice()
        }, l.tickValues = function(t) {
            return arguments.length ? (r = null == t ? null : $.call(t), l) : r && r.slice()
    ...
    xn.prototype = wn.prototype = {
        ...
        selectChild: function(t) {
            return this.select(null == t ? Mt : function(t) {
                return function() {
        ...
        selectChildren: function(t) {
            return this.selectAll(null == t ? Tt : function(t) {
                return function() {
        ...
        attr: function(t, n) {
            ...
            return this.each((null == n ? e.local ? qt : Dt : "function" == typeof n ? e.local ? Ut : Ot : e.local ? Ft : Rt)(e, n))
        },
        style: function(t, n, e) {
            return arguments.length > 1 ? this.each((null == n ? Bt : "function" == typeof n ? Lt : Yt)(t, n, null == e ? "" : e)) : jt(this.node(), t)
        },
        property: function(t, n) {
            return arguments.length > 1 ? this.each((null == n ? Ht : "function" == typeof n ? Gt : Xt)(t, n)) : this.node()[t]
        },
        ...
        html: function(t) {
            return arguments.length ? this.each(null == t ? on : ("function" == typeof t ? un : an)(t)) : this.node().innerHTML
        },
        raise: function() {
            return this.each(cn)
        },
    ...
    function zn(t, n) {
        ...
        n && (r.on("click.drag", Cn, !0), setTimeout((function() {
    ...
    function re(t) {
        var n, e;
        return t = (t + "").trim().toLowerCase(), (n = Vn.exec(t)) ? (e = n[1].length, n = parseInt(n[1], 16), 6 === e ? ie(n) : 3 === e ? new ce(n >> 8 & 15 | n >> 4 & 240, n >> 4 & 15 | 240 & n, (15 & n) << 4 | 15 & n, 1) : 8 === e ? oe(n >> 24 & 255, n >> 16 & 255, n >> 8 & 255, (255 & n) / 255) : 4 === e ? oe(n >> 12 & 15 | n >> 8 & 240, n >> 8 & 15 | n >> 4 & 240, n >> 4 & 15 | 240 & n, ((15 & n) << 4 | 15 & n) / 255) : null) : (n = $n.exec(t)) ? new ce(n[1], n[2], n[3], 1) : (n = Wn.exec(t)) ? new ce(255 * n[1] / 100, 255 * n[2] / 100, 255 * n[3] / 100, 1) : (n = Zn.exec(t)) ? oe(n[1], n[2], n[3], n[4]) : (n = Kn.exec(t)) ? oe(255 * n[1] / 100, 255 * n[2] / 100, 255 * n[3] / 100, n[4]) : (n = Qn.exec(t)) ? he(n[1], n[2] / 100, n[3] / 100, 1) : (n = Jn.exec(t)) ? he(n[1], n[2] / 100, n[3] / 100, n[4]) : te.hasOwnProperty(t) ? ie(te[t]) : "transparent" === t ? new ce(NaN, NaN, NaN, 0) : null
    }
    function ie(t) {
    ...
    function ae(t) {
        return t instanceof Yn || (t = re(t)), t ? new ce((t = t.rgb()).r, t.g, t.b, t.opacity) : new ce
    }
    function ue(t, n, e, r) {
    ...
    In(Yn, re, {
        ...
        brighter: function(t) {
            return t = null == t ? jn : Math.pow(jn, t), new ce(this.r * t, this.g * t, this.b * t, this.opacity)
        },
        darker: function(t) {
            return t = null == t ? Ln : Math.pow(Ln, t), new ce(this.r * t, this.g * t, this.b * t, this.opacity)
        },
        rgb: function() {
            return this
        },
        ...
        darker: function(t) {
            return t = null == t ? Ln : Math.pow(Ln, t), new ge(this.h, this.s, this.l * t, this.opacity)
        },
        rgb: function() {
    ...
    function Ee(t) {
        return t > .008856451679035631 ? Math.pow(t, 1 / 3) : t / Me + xe
    }
    function ke(t) {
    ...
    function Pe(t) {
        ...
        if (t instanceof Se || (t = Ae(t)), 0 === t.a && 0 === t.b) return new De(NaN, 0 < t.l && t.l < 100 ? 0 : NaN, t.l, t.opacity);
    ...
    In(Se, Te, Bn(Yn, {
        brighter: function(t) {
            return new Se(this.l + 18 * (null == t ? 1 : t), this.a, this.b, this.opacity)
        },
        darker: function(t) {
            return new Se(this.l - 18 * (null == t ? 1 : t), this.a, this.b, this.opacity)
        },
    ...
    In(Xe, He, Bn(Yn, {
        brighter: function(t) {
            return t = null == t ? jn : Math.pow(jn, t), new Xe(this.h, this.s, this.l * t, this.opacity)
        },
        darker: function(t) {
            return t = null == t ? Ln : Math.pow(Ln, t), new Xe(this.h, this.s, this.l * t, this.opacity)
        },
        rgb: function() {
    ...
    function hr(t, n) {
        var e, r, i, o = sr.lastIndex = lr.lastIndex = 0,
            ...
            c = [];
        for (t += "", n += "";
            (e = sr.exec(t)) && (r = lr.exec(n));)(i = r.index) > o && (i = n.slice(o, i), u[a] ? u[a] += i : u[++a] = i), (e = e[0]) === (r = r[0]) ? u[a] ? u[a] += r : u[++a] = r : (u[++a] = null, c.push({
            i: a,
            x: cr(e, r)
        })), o = lr.lastIndex;
    ...
    function dr(t, n) {
        var e, r = typeof n;
        return null == n || "boolean" === r ? We(n) : ("number" === r ? cr : "string" === r ? (e = re(n)) ? (n = e, tr) : hr : n instanceof re ? tr : n instanceof Date ? ur : or(n) ? ir : Array.isArray(n) ? ar : "function" != typeof n.valueOf && "function" != typeof n.toString || isNaN(n) ? fr : cr)(t, n)
    }
    function pr(t, n) {
        return t = +t, n = +n,
            function(e) {
    ...
    var mr = br((function(t) {
            const n = new("function" == typeof DOMMatrix ? DOMMatrix : WebKitCSSMatrix)(t + "");
            return n.isIdentity ? vr : _r(n.a, n.b, n.c, n.d, n.e, n.f)
        }), "px, ", "px)", "deg)"),
        xr = br((function(t) {
            return null == t ? vr : (gr || (gr = document.createElementNS("http://www.w3.org/2000/svg", "g")), gr.setAttribute("transform", t), (t = gr.transform.baseVal.consolidate()) ? _r((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f) : vr)
        }), ", ", ")", ")");
    function wr(t) {
    ...
    function $r() {
        Hr(), ++Fr;
        for (var t, n = qr; n;)(t = Br - n._time) >= 0 && n._call.call(null, t), n = n._next;
        --Fr
    }
    function Wr() {
    ...
    function Kr(t) {
        Fr || (Or && (Or = clearTimeout(Or)), t - Br > 24 ? (t < 1 / 0 && (Or = setTimeout(Wr, t - Lr.now() - Yr)), Ur && (Ur = clearInterval(Ur))) : (Ur || (Ir = Lr.now(), Ur = setInterval(Zr, 1e3)), Fr = 1, jr(Wr)))
    }
    function Qr(t, n, e) {
        var r = new Gr;
    ...
    function fi(t, n) {
        var e;
        return ("number" == typeof n ? cr : n instanceof re ? tr : (e = re(n)) ? (n = e, tr) : hr)(t, n)
    }
    function si(t) {
        return function() {
            this.removeAttribute(t)
    ...
    Di.prototype = qi.prototype = {
        ...
        on: function(t, n) {
            var e = this._id;
            return arguments.length < 2 ? ii(this.node(), e).on.on(t) : this.each(Ti(e, t, n))
        },
        attr: function(t, n) {
            var e = lt(t),
                r = "transform" === e ? xr : fi;
        ...
        delay: function(t) {
            var n = this._id;
            return arguments.length ? this.each(("function" == typeof t ? mi : xi)(n, t)) : ii(this.node(), n).delay
        },
        duration: function(t) {
            var n = this._id;
            return arguments.length ? this.each(("function" == typeof t ? wi : Mi)(n, t)) : ii(this.node(), n).duration
        },
        ease: function(t) {
            var n = this._id;
    ...
    var $i = 4 / 11,
        Wi = 7.5625;
    function Zi(t) {
        return (t = +t) < $i ? Wi * t * t : t < .7272727272727273 ? Wi * (t -= .5454545454545454) * t + .75 : t < .9090909090909091 ? Wi * (t -= .8181818181818182) * t + .9375 : Wi * (t -= .9545454545454546) * t + .984375
    }
    var Ki = 1.70158,
        Qi = function t(n) {
            function e(t) {
        ...
        io = function t(n, e) {
            var r = Math.asin(1 / (n = Math.max(1, n))) * (e /= no);
            function i(t) {
                return ((t = 2 * t - 1) < 0 ? n * Xi(-t) * Math.sin((r - t) / e) : 2 - n * Xi(t) * Math.sin((r + t) / e)) / 2
            }
            return i.amplitude = function(n) {
                return t(n, e * no)
            }, i.period = function(e) {
    ...
    function Fo(t) {
        ...
        return c.move = function(n, e) {
            ...
            return arguments.length ? (e = "function" == typeof t ? t : co(xo(t)), c) : e
        }, c.filter = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : co(!!t), c) : r
        }, c.touchable = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : co(!!t), c) : i
    ...
    function Vo(t, n) {
        ...
        return a.padAngle = function(t) {
            ...
            return arguments.length ? (null == t ? o = null : (o = Go(t))._ = t, a) : o && o._
        }, a
    }
    const $o = Math.PI,
        Wo = 2 * $o,
    ...
    function fa(t) {
        ...
        return t && (f.headRadius = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : na(+n), f) : t
        }), f.radius = function(t) {
            return arguments.length ? (r = i = "function" == typeof t ? t : na(+t), f) : r
        }, f.sourceRadius = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : na(+t), f) : r
        }, f.targetRadius = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : na(+t), f) : i
        }, f.startAngle = function(t) {
            return arguments.length ? (o = "function" == typeof t ? t : na(+t), f) : o
        }, f.endAngle = function(t) {
            return arguments.length ? (a = "function" == typeof t ? t : na(+t), f) : a
        }, f.padAngle = function(t) {
            return arguments.length ? (u = "function" == typeof t ? t : na(+t), f) : u
        }, f.source = function(t) {
    ...
    function _a() {
        ...
        return i.contour = o, i.size = function(e) {
            ...
            return arguments.length ? (e = "function" == typeof t ? t : Array.isArray(t) ? ha(sa.call(t)) : ha(t), i) : e
        }, i.smooth = function(t) {
    ...
    function Na(t, n, e, r, i, o) {
        return (ka(i, o, t, n, e, r) || ka(t, n, e, r, i, o) || ka(e, r, i, o, t, n)) < 0
    }
    ...
    class Xa {
        ...
        constructor(t) {
            this._delaunator = new Sa(t), this.inedges = new Int32Array(t.length / 2), this._hullIndex = new Int32Array(t.length / 2), this.points = this._delaunator.coords, this._init()
        }
        update() {
        ...
        _step(t, n, e) {
            ...
            do {
                ...
                if (h = a[h], -1 === h) {
                    if (h = i[(o[t] + 1) % i.length], h !== r && Ya(n - c[2 * h], 2) + Ya(e - c[2 * h + 1], 2) < s) return h;
                    break
                }
            } while (h !== l);
            return f
    ...
    function Ka(t) {
        ...
        }(t.getUTCFullYear()) + "-" + Za(t.getUTCMonth() + 1, 2) + "-" + Za(t.getUTCDate(), 2) + (i ? "T" + Za(n, 2) + ":" + Za(e, 2) + ":" + Za(r, 2) + "." + Za(i, 3) + "Z" : r ? "T" + Za(n, 2) + ":" + Za(e, 2) + ":" + Za(r, 2) + "Z" : e || n ? "T" + Za(n, 2) + ":" + Za(e, 2) + "Z" : "")
    }
    function Qa(t) {
        var n = new RegExp('["' + t + "\n\r]"),
            e = t.charCodeAt(0);
        ...
        function a(t) {
            return null == t ? "" : t instanceof Date ? Ka(t) : n.test(t += "") ? '"' + t.replace(/"/g, '""') + '"' : t
        }
        return {
            parse: function(t, n) {
            ...
            parseRows: r,
            format: function(n, e) {
                return null == e && (e = Wa(n)), [e.map(a).join(t)].concat(i(n, e)).join("\n")
            },
    ...
    function mu(t) {
        return function(n, e, r) {
            return 2 === arguments.length && "function" == typeof e && (r = e, e = void 0), bu(n, e).then((function(n) {
                return t(n, r)
            }))
        }
    }
    ...
    function Au(t) {
        return (n, e) => bu(n, e).then(n => (new DOMParser).parseFromString(n, t))
    }
    ...
    Zu.prototype = Ku.prototype, Ku.prototype.toString = function() {
    ...
    function ic(t) {
        var n, e, r = void 0 === t.grouping || void 0 === t.thousands ? tc : (n = ec.call(t.grouping, Number), e = t.thousands + "", function(t, r) {
    ...
    function oc(n) {
        return nc = ic(n), t.format = nc.format, t.formatPrefix = nc.formatPrefix, nc
    }
    function ac(t) {
        return Math.max(0, -Vu(Math.abs(t)))
    }
    function uc(t, n) {
        return Math.max(0, 3 * Math.max(-8, Math.min(8, Math.floor(Vu(n) / 3))) - Vu(Math.abs(t)))
    }
    function cc(t, n) {
        return t = Math.abs(t), n = Math.abs(n) - t, Math.max(0, Vu(n) - Vu(t)) + 1
    }
    oc({
        thousands: ",",
        grouping: [3],
    ...
    var Rc = {
            ...
            FeatureCollection: function(t, n) {
                for (var e = t.features, r = -1, i = e.length; ++r < i;) qc(e[r].geometry, n)
            }
        },
        Fc = {
            Sphere: function(t, n) {
            ...
            MultiLineString: function(t, n) {
                for (var e = t.coordinates, r = -1, i = e.length; ++r < i;) Oc(e[r], n, 0)
            },
            Polygon: function(t, n) {
                Uc(t.coordinates, n)
            },
            MultiPolygon: function(t, n) {
                for (var e = t.coordinates, r = -1, i = e.length; ++r < i;) Uc(e[r], n)
            },
    ...
    function cf(t, n) {
        of.point = ff, Bc = t, Yc = n, Lc = t *= yc, jc = mc(n = (n *= yc) / 2 + dc), Hc = Sc(n)
    }
    function ff(t, n) {
        var e = (t *= yc) - Lc,
            r = e >= 0 ? 1 : -1,
    ...
    var vf, _f, bf, mf, xf, wf, Mf, Af, Tf, Sf, Ef, kf, Nf, Cf, Pf, zf, Df = {
        point: qf,
        lineStart: Ff,
        lineEnd: Of,
        polygonStart: function() {
            Df.point = Uf, Df.lineStart = If, Df.lineEnd = Bf, Jc = new g, of.polygonStart()
        },
        polygonEnd: function() {
            of.polygonEnd(), Df.point = qf, Df.lineStart = Ff, Df.lineEnd = Of, ef < 0 ? (Xc = -(Vc = 180), Gc = -($c = 90)) : Jc > fc ? $c = 90 : Jc < -1e-6 && (Gc = -90), nf[0] = Xc, nf[1] = Vc
        },
        sphere: function() {
            Xc = -(Vc = 180), Gc = -($c = 90)
        }
    ...
    function qf(t, n) {
        tf.push(nf = [Xc = t, Vc = t]), n < Gc && (Gc = n), n > $c && ($c = n)
    }
    function Rf(t, n) {
        var e = lf([t * yc, n * yc]);
        if (Qc) {
    ...
    function Bf() {
        Uf(Zc, Kc), of.lineEnd(), vc(Jc) > fc && (Xc = -(Vc = 180)), nf[0] = Xc, nf[1] = Vc, Qc = null
    }
    function Yf(t, n) {
    ...
    function is(t, n, e) {
        return (t %= pc) ? n || e ? es(as(t), us(n, e)) : as(t) : n || e ? us(n, e) : rs
    }
    function os(t) {
        return function(n, e) {
    ...
    function cs(t) {
        ...
        return t = is(t[0] * yc, t[1] * yc, t.length > 2 ? t[2] * yc : 0), n.invert = function(n) {
    ...
    function ms(t, n) {
        return ((t = t.x)[0] < 0 ? t[1] - hc - fc : hc - t[1]) - ((n = n.x)[0] < 0 ? n[1] - hc - fc : hc - n[1])
    }
    rs.invert = rs;
    var xs = _s((function() {
        return !0
        ...
        return {
            ...
            point: function(o, a) {
                var u = o > 0 ? lc : -lc,
                    c = vc(o - e);
                vc(c - lc) < fc ? (t.point(e, r = (r + a) / 2 > 0 ? hc : -hc), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(u, r), t.point(o, r), n = 0) : i !== u && c >= lc && (vc(e - i) < fc && (e -= i * fc), vc(o - u) < fc && (o -= u * fc), r = function(t, n, e, r) {
                    var i, o, a = Sc(t - e);
                    return vc(a) > fc ? _c((Sc(n) * (o = mc(r)) * Sc(e) - Sc(r) * (i = mc(n)) * Sc(t)) / (i * o * a)) : (n + r) / 2
    ...
    function ws(t) {
        ...
        function a(t, e, r) {
            ...
            if (!(y < 0)) {
                ...
                var A = x - m,
                    T = vc(A - lc) < fc;
                if (!T && M < w && (b = w, w = M, M = b), T || A < fc ? T ? w + M > 0 ^ _[1] < (vc(_[0] - m) < fc ? w : M) : w <= _[1] && _[1] <= M : A > lc ^ (m <= _[0] && _[0] <= x)) {
                    var S = gf(d, (-p + v) / g);
    ...
    function Ns(t, n, e, r) {
        ...
        function a(r, i) {
            return vc(r[0] - t) < fc ? i > 0 ? 0 : 3 : vc(r[0] - e) < fc ? i > 0 ? 2 : 1 : vc(r[1] - n) < fc ? i > 0 ? 1 : 0 : i > 0 ? 3 : 2
        }
        function u(t, n) {
            return c(t.x, n.x)
        }
    ...
    function $s() {
        ...
        function _() {
            return B(xc(r / p) * p, e, p).map(s).concat(B(xc(u / g) * g, a, g).map(l)).concat(B(xc(n / h) * h, t, h).filter((function(t) {
                return vc(t % p) > fc
            })).map(c)).concat(B(xc(o / d) * d, i, d).filter((function(t) {
                return vc(t % g) > fc
            })).map(f))
        }
        return v.lines = function() {
            ...
            return arguments.length ? (y = +h, c = Gs(o, i, 90), f = Vs(n, t, y), s = Gs(u, a, 90), l = Vs(r, e, y), v) : y
        }, v.extentMajor([
            [-180, -89.999999],
            [180, 89.999999]
        ]).extentMinor([
    ...
    var Ws, Zs, Ks, Qs, Js = t => t,
        ...
        el = {
            ...
            polygonEnd: function() {
                el.lineStart = el.lineEnd = el.point = Dc, tl.add(vc(nl)), nl = new g
            },
            result: function() {
                var t = tl / 2;
                return tl = new g, t
    ...
    var hl, dl, pl, gl, yl = 0,
        ...
        Tl = {
            ...
            result: function() {
                var t = Al ? [wl / Al, Ml / Al] : xl ? [bl / xl, ml / xl] : _l ? [yl / _l, vl / _l] : [NaN, NaN];
    ...
    function Wl(t, n, e) {
        ...
        return t.scale(150).translate([0, 0]), null != r && t.clipExtent(null), Ic(e, t.stream(ll)), n(ll.result()), null != r && t.clipExtent(r), t
    }
    function Zl(t, n, e) {
    ...
    function oh(t) {
        ...
        return E.stream = function(t) {
                return f && s === t ? f : f = eh(function(t) {
                    return Vl({
                        point: function(n, e) {
                            var r = t(n, e);
                ...
                return arguments.length ? (M = +t ? ws(w = t * yc) : (w = null, xs), C()) : w * gc
                ...
                return arguments.length ? (p = t[0] % 360 * yc, g = t[1] % 360 * yc, N()) : [p * gc, g * gc]
            }, E.rotate = function(t) {
                return arguments.length ? (y = t[0] % 360 * yc, v = t[1] % 360 * yc, _ = t.length > 2 ? t[2] % 360 * yc : 0, N()) : [y * gc, v * gc, _ * gc]
            }, E.angle = function(t) {
    ...
    function ah(t) {
        ...
        return i.parallels = function(t) {
            return arguments.length ? r(n = t[0] * yc, e = t[1] * yc) : [n * gc, e * gc]
        }, i
    }
    function uh(t, n) {
        var e = Sc(t),
    ...
    function Yh(t) {
        for (var n, e, r = 0, i = (t = function(t) {
                ...
                return t
            }(Array.from(t))).length, o = []; r < i;) n = t[r], e && Hh(e, n) ? ++r : (e = Gh(o = Lh(o, n)), r = 0);
        return e
    }
    function Lh(t, n) {
        var e, r;
    ...
    Th.invert = function(t, n) {
        for (var e, r = n, i = r * r, o = i * i * i, a = 0; a < 12 && (o = (i = (r -= e = (r * (mh + xh * i + o * (wh + Mh * i)) - n) / (mh + 3 * xh * i + o * (7 * wh + 9 * Mh * i))) * r) * i * i, !(vc(e) < sc)); ++a);
        return [Ah * t * (mh + 3 * xh * i + o * (7 * wh + 9 * Mh * i)) / mc(r), Pc(Sc(r) / Ah)]
    }, Sh.invert = lh(_c), Eh.invert = function(t, n) {
        var e, r = n,
            i = 25;
        do {
            var o = r * r,
    ...
    }, kh.invert = lh(Pc), Nh.invert = lh((function(t) {
        return 2 * _c(t)
    ...
    function wd(t, n, e, r, i, o) {
        for (var a, u, c, f, s, l, h, d, p, g, y, v = [], _ = n.children, b = 0, m = 0, x = _.length, w = n.value; b < x;) {
            ...
            }), a.dice ? fd(a, e, r, i, w ? r += f * s / w : o) : md(a, e, r, w ? e += c * s / w : i, o), w -= s, b = m
        }
        return v
    }
    var Md = function t(n) {
    ...
    function Kd() {
        ...
        return delete e.unknown, e.domain = function(t) {
            ...
            return Kd(r(), [o, a]).round(u).paddingInner(c).paddingOuter(f).align(s)
    ...
    function vp(n) {
        ...
        function u() {
            ...
            }(a), o()[0] < 0 ? (e = yp(e), r = yp(r), n(dp, pp)) : n(lp, hp), i
        }
    ...
    function Ap(t) {
        var n = t(np, np),
            e = 1;
        function r() {
            return 1 === e ? t(np, np) : .5 === e ? t(wp, Mp) : t(xp(e), xp(1 / e))
        }
    ...
    function Cp(t, n, e, r) {
        ...
        return i.floor = function(n) {
            ...
            return kp.setTime(+n), Np.setTime(+r), t(kp), t(Np), Math.floor(e(kp, Np))
        }, i.every = function(t) {
    ...
    var Pp = Cp((function() {}), (function(t, n) {
        t.setTime(+t + n)
    }), (function(t, n) {
        return n - t
    }));
    Pp.every = function(t) {
        return t = Math.floor(t), isFinite(t) && t > 0 ? t > 1 ? Cp((function(n) {
    ...
    var zp = Pp.range,
        ...
        Yp = Bp.range,
        Lp = Cp((function(t) {
            t.setTime(t - t.getMilliseconds() - t.getSeconds() * Dp - t.getMinutes() * qp)
        }), (function(t, n) {
            t.setTime(+t + n * Rp)
        }), (function(t, n) {
            return (n - t) / Rp
    ...
    function Gp(t) {
        return Cp((function(n) {
            ...
            return (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * qp) / Op
        }))
    }
    var Vp = Gp(0),
        $p = Gp(1),
    ...
    fg.every = function(t) {
        return isFinite(t = Math.floor(t)) && t > 0 ? Cp((function(n) {
        ...
        function M(t, n) {
            return function(e) {
                ...
                if (n && !("Z" in o) && (o.Z = 0), "p" in o && (o.H = o.H % 12 + 12 * o.p), void 0 === o.m && (o.m = "q" in o ? o.q : 0), "V" in o) {
                    ...
                    "w" in o || (o.w = 1), "Z" in o ? (i = (r = Og(Ug(o.y, 0, 1))).getUTCDay(), r = i > 4 || 0 === i ? bg.ceil(r) : bg(r), r = gg.offset(r, 7 * (o.V - 1)), o.y = r.getUTCFullYear(), o.m = r.getUTCMonth(), o.d = r.getUTCDate() + (o.w + 6) % 7) : (i = (r = Fg(Ug(o.y, 0, 1))).getDay(), r = i > 4 || 0 === i ? $p.ceil(r) : $p(r), r = Hp.offset(r, 7 * (o.V - 1)), o.y = r.getFullYear(), o.m = r.getMonth(), o.d = r.getDate() + (o.w + 6) % 7)
                } else("W" in o || "U" in o) && ("w" in o || (o.w = "u" in o ? o.u % 7 : "W" in o ? 1 : 0), i = "Z" in o ? Og(Ug(o.y, 0, 1)).getUTCDay() : Fg(Ug(o.y, 0, 1)).getDay(), o.m = 0, o.d = "W" in o ? (o.w + 6) % 7 + 7 * o.W - (i + 5) % 7 : o.w + 7 * o.U - (i + 6) % 7);
                return "Z" in o ? (o.H += o.Z / 100 | 0, o.M += o.Z % 100, Og(o)) : Fg(o)
            }
        }
        function A(t, n, e, r) {
            for (var i, o, a = 0, u = n.length, c = e.length; a < u;) {
                ...
                if (37 === (i = n.charCodeAt(a++))) {
                    if (i = n.charAt(a++), !(o = x[i in Yg ? n.charAt(a++) : i]) || (r = o(t, e, r)) < 0) return -1
    ...
    function Dy(t, n) {
        var e = t.getDay();
        return Xg((t = e >= 4 || 0 === e ? Kp(t) : Kp.ceil(t)).getFullYear() % 1e4, n, 4)
    }
    function qy(t) {
        var n = t.getTimezoneOffset();
        return (n > 0 ? "-" : (n *= -1, "+")) + Xg(n / 60 | 0, "0", 2) + Xg(n % 60, "0", 2)
    }
    function Ry(t, n) {
    ...
    function Vy(t, n) {
        return t = Gy(t), Xg(wg.count(qg(t), t) + (4 === qg(t).getUTCDay()), n, 2)
    }
    function $y(t) {
        return t.getUTCDay()
    }
    ...
    function Jy(t, n) {
        var e = t.getUTCDay();
        return Xg((t = e >= 4 || 0 === e ? wg(t) : wg.ceil(t)).getUTCFullYear() % 1e4, n, 4)
    }
    function tv() {
        return "+0000"
    }
    ...
    function iv(n) {
        return Bg = Ig(n), t.timeFormat = Bg.format, t.timeParse = Bg.parse, t.utcFormat = Bg.utcFormat, t.utcParse = Bg.utcParse, Bg
    }
    iv({
        dateTime: "%x, %X",
        date: "%-m/%-d/%Y",
    ...
    var uv = +new Date("2000-01-01T00:00:00.000Z") ? function(t) {
            var n = new Date(t);
    ...
    function vv() {
        ...
        return f.domain = function(i) {
            ...
            }, f.range = s(dr), f.rangeRound = s(pr), f.unknown = function(t) {
    ...
    function mv() {
        ...
        function p(t) {
            return function(n) {
                var e, r, i;
                return arguments.length ? ([e, r, i] = n, l = Dr(t, [e, r, i]), d) : [l(0), l(.5), l(1)]
            }
        }
        return d.domain = function(a) {
            ...
            }, d.range = p(dr), d.rangeRound = p(pr), d.unknown = function(t) {
    ...
    function bb(t, n) {
        ...
        return t = "function" == typeof t ? t : void 0 === t ? vb : G_(t), n = "function" == typeof n ? n : void 0 === n ? _b : G_(n), a.x = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : G_(+n), a) : t
        }, a.y = function(t) {
            return arguments.length ? (n = "function" == typeof t ? t : G_(+t), a) : n
        }, a.defined = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : G_(!!t), a) : e
        }, a.curve = function(t) {
    ...
    function mb(t, n, e) {
        ...
        return t = "function" == typeof t ? t : void 0 === t ? vb : G_(+t), n = "function" == typeof n ? n : G_(void 0 === n ? 0 : +n), e = "function" == typeof e ? e : void 0 === e ? _b : G_(+e), c.x = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : G_(+n), r = null, c) : t
        }, c.x0 = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : G_(+n), c) : t
        }, c.x1 = function(t) {
            return arguments.length ? (r = null == t ? null : "function" == typeof t ? t : G_(+t), c) : r
        }, c.y = function(t) {
            return arguments.length ? (n = "function" == typeof t ? t : G_(+t), e = null, c) : n
        }, c.y0 = function(t) {
            return arguments.length ? (n = "function" == typeof t ? t : G_(+t), c) : n
        }, c.y1 = function(t) {
            return arguments.length ? (e = null == t ? null : "function" == typeof t ? t : G_(+t), c) : e
            ...
            return arguments.length ? (i = "function" == typeof t ? t : G_(!!t), c) : i
        }, c.curve = function(t) {
    ...
    function zb(t) {
        ...
        return a.source = function(t) {
            ...
            return arguments.length ? (r = "function" == typeof t ? t : G_(+t), a) : r
        }, a.y = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : G_(+t), a) : i
        }, a.context = function(t) {
    ...
    Lm.prototype = {
        ...
        translate: function(t, n) {
            return 0 === t & 0 === n ? this : new Lm(this.k, this.x + this.k * t, this.y + this.k * n)
        },
        apply: function(t) {
    ...
    Hm.prototype = Lm.prototype, t.Adder = g, t.Delaunay = Xa, t.FormatSpecifier = Ku, t.Voronoi = Ia, t.active = function(t, n) {
        ...
        return c.centroid = function() {
            ...
            return arguments.length ? (e = "function" == typeof t ? t : G_(+t), c) : e
        }, c.padRadius = function(t) {
            return arguments.length ? (r = null == t ? null : "function" == typeof t ? t : G_(+t), c) : r
        }, c.startAngle = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : G_(+t), c) : i
        }, c.endAngle = function(t) {
            return arguments.length ? (o = "function" == typeof t ? t : G_(+t), c) : o
        }, c.padAngle = function(t) {
            return arguments.length ? (a = "function" == typeof t ? t : G_(+t), c) : a
        }, c.context = function(t) {
        ...
        return l.x = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : ha(+n), l) : t
        }, l.y = function(t) {
            return arguments.length ? (n = "function" == typeof t ? t : ha(+t), l) : n
        }, l.weight = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : ha(+t), l) : e
        }, l.size = function(t) {
            ...
            return arguments.length ? (s = "function" == typeof t ? t : Array.isArray(t) ? ha(sa.call(t)) : ha(t), l) : s
    ...
    }, t.contours = _a, t.count = c, t.create = function(t) {
        return Mn(pt(t).call(document.documentElement))
    }, t.creator = pt, t.cross = function(...t) {
        ...
        return new im(t)
    }, t.curveBundle = am, t.curveCardinal = fm, t.curveCardinalClosed = lm, t.curveCardinalOpen = dm, t.curveCatmullRom = ym, t.curveCatmullRomClosed = _m, t.curveCatmullRomOpen = mm, t.curveLinear = yb, t.curveLinearClosed = function(t) {
        return new xm(t)
        ...
        function g(t) {
            Mn(t.view).on("mousemove.drag mouseup.drag", null), zn(t.view, e), Cn(t), c.mouse("end", t)
        }
        function y(t, n) {
            if (i.call(this, t, n)) {
        ...
        function _(t) {
            ...
            for (r && clearTimeout(r), r = setTimeout((function() {
                    r = null
                }), 500), n = 0; n < o; ++n)(e = c[i[n].identifier]) && (Nn(t), e("end", t, i[n]))
        }
    ...
    }, t.dragDisable = Pn, t.dragEnable = zn, t.dsv = function(t, n, e, r) {
        3 === arguments.length && "function" == typeof e && (r = e, e = void 0);
        var i = Qa(t);
        return bu(n, e).then((function(t) {
            return i.parse(t, r)
        }))
    }, t.dsvFormat = Qa, t.easeBack = to, t.easeBackIn = Qi, t.easeBackInOut = to, t.easeBackOut = Ji, t.easeBounce = Zi, t.easeBounceIn = function(t) {
        return 1 - Zi(1 - t)
    }, t.easeBounceInOut = function(t) {
        return ((t *= 2) <= 1 ? 1 - Zi(1 - t) : Zi(t - 1) + 1) / 2
    }, t.easeBounceOut = Zi, t.easeCircle = Vi, t.easeCircleIn = function(t) {
        return 1 - Math.sqrt(1 - t * t)
    }, t.easeCircleInOut = Vi, t.easeCircleOut = function(t) {
        return Math.sqrt(1 - --t * t)
    }, t.easeCubic = Ui, t.easeCubicIn = function(t) {
        return t * t * t
    }, t.easeCubicInOut = Ui, t.easeCubicOut = function(t) {
        return --t * t * t + 1
    }, t.easeElastic = ro, t.easeElasticIn = eo, t.easeElasticInOut = io, t.easeElasticOut = ro, t.easeExp = Gi, t.easeExpIn = function(t) {
        return Xi(1 - +t)
    }, t.easeExpInOut = Gi, t.easeExpOut = function(t) {
        return 1 - Xi(t)
    }, t.easeLinear = t => +t, t.easePoly = Yi, t.easePolyIn = Ii, t.easePolyInOut = Yi, t.easePolyOut = Bi, t.easeQuad = Oi, t.easeQuadIn = function(t) {
        return t * t
    }, t.easeQuadInOut = Oi, t.easeQuadOut = function(t) {
        return t * (2 - t)
    }, t.easeSin = Hi, t.easeSinIn = function(t) {
        return 1 == +t ? 1 : 1 - Math.cos(t * ji)
    }, t.easeSinInOut = Hi, t.easeSinOut = function(t) {
        ...
        return "function" != typeof t && (t = Fu(null == t ? 1 : +t)), a.initialize = function(t, e) {
            n = t, r = e, c()
            ...
            return arguments.length ? (t = "function" == typeof n ? n : Fu(+n), c(), a) : t
        }, a
        ...
        return null == t && (t = []), l.initialize = function(t, n) {
            ...
            return arguments.length ? (c = "function" == typeof t ? t : Fu(+t), d(), l) : c
        }, l.distance = function(t) {
            return arguments.length ? (f = "function" == typeof t ? t : Fu(+t), p(), l) : f
        }, l
        ...
        return f.initialize = function(n, r) {
            ...
            return arguments.length ? (o = "function" == typeof t ? t : Fu(+t), s(), f) : o
        ...
        return "function" != typeof t && (t = Fu(+t)), null == n && (n = 0), null == e && (e = 0), u.initialize = function(t) {
            r = t, c()
        }, u.strength = function(t) {
            return arguments.length ? (a = "function" == typeof t ? t : Fu(+t), c(), u) : a
        }, u.radius = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : Fu(+n), c(), u) : t
        }, u.x = function(t) {
        ...
        return "function" != typeof t && (t = Fu(null == t ? 0 : +t)), o.initialize = function(t) {
            n = t, a()
        }, o.strength = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : Fu(+t), a(), o) : i
        }, o.x = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : Fu(+n), a(), o) : t
        }, o
    }, t.forceY = function(t) {
        var n, e, r, i = Fu(.1);
        function o(t) {
    ...
    }, t.geoAzimuthalEqualAreaRaw = hh, t.geoAzimuthalEquidistant = function() {
        return ih(dh).scale(79.4188).clipAngle(179.999)
    }, t.geoAzimuthalEquidistantRaw = dh, t.geoBounds = function(t) {
        var n, e, r, i, o, a, u;
        if ($c = Vc = -(Xc = Gc = 1 / 0), tf = [], Ic(t, Df), e = tf.length) {
            for (tf.sort(Lf), n = 1, o = [r = tf[0]]; n < e; ++n) jf(r, (i = tf[n])[0]) || jf(r, i[1]) ? (Yf(r[0], i[1]) > Yf(r[0], r[1]) && (r[1] = i[1]), Yf(i[0], r[1]) > Yf(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
            for (a = -1 / 0, n = 0, r = o[e = o.length - 1]; n <= e; r = i, ++n) i = o[n], (u = Yf(r[1], i[0])) > a && (a = u, Xc = i[0], Vc = r[1])
        }
        ...
        function a() {
            ...
            return t = [], n = is(-a[0] * yc, -a[1] * yc, 0).invert, fs(o, u, c, 1), a = {
                type: "Polygon",
                coordinates: [t]
            }, t = n = null, a
        }
        return a.center = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : ns([+t[0], +t[1]]), a) : e
        }, a.radius = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : ns(+t), a) : r
        }, a.precision = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : ns(+t), a) : i
        }, a
    ...
    }, t.geoClipRectangle = Ns, t.geoConicConformal = function() {
        return ah(vh).scale(109.5).parallels([30, 30])
    }, t.geoConicConformalRaw = vh, t.geoConicEqualArea = ch, t.geoConicEqualAreaRaw = uh, t.geoConicEquidistant = function() {
        return ah(bh).scale(131.154).center([0, 13.9389])
    }, t.geoConicEquidistantRaw = bh, t.geoContains = function(t, n) {
        return (t && Us.hasOwnProperty(t.type) ? Us[t.type] : Bs)(t, n)
    }, t.geoDistance = Os, t.geoEqualEarth = function() {
        return ih(Th).scale(177.158)
    }, t.geoEqualEarthRaw = Th, t.geoEquirectangular = function() {
        return ih(_h).scale(152.63)
    }, t.geoEquirectangularRaw = _h, t.geoGnomonic = function() {
        return ih(Sh).scale(144.049).clipAngle(60)
    }, t.geoGnomonicRaw = Sh, t.geoGraticule = $s, t.geoGraticule10 = function() {
        return $s()()
        ...
        return b.invert = function(e) {
            ...
            return arguments.length ? (n = Sc(h = e % 360 * yc), t = mc(h), _()) : h * gc
    ...
    }, t.geoLength = qs, t.geoMercator = function() {
        return gh(ph).scale(961 / pc)
    }, t.geoMercatorRaw = ph, t.geoNaturalEarth1 = function() {
        return ih(Eh).scale(175.295)
    }, t.geoNaturalEarth1Raw = Eh, t.geoOrthographic = function() {
        return ih(kh).scale(249.5).clipAngle(90.000001)
    }, t.geoOrthographicRaw = kh, t.geoPath = function(t, n) {
        var e, r, i = 4.5;
        function o(t) {
            return t && ("function" == typeof i && r.pointRadius(+i.apply(this, arguments)), Ic(t, e(r))), r.result()
        }
        return o.area = function(t) {
            ...
            return arguments.length ? (e = null == n ? (t = null, Js) : (t = n).stream, o) : t
        }, o.context = function(t) {
            return arguments.length ? (r = null == t ? (n = null, new Xl) : new Rl(n = t), "function" != typeof i && r.pointRadius(i), o) : n
        }, o.pointRadius = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : (r.pointRadius(+t), +t), o) : i
        }, o.projection(t).context(n)
    }, t.geoProjection = ih, t.geoProjectionMutator = oh, t.geoRotation = cs, t.geoStereographic = function() {
        return ih(Nh).scale(250).clipAngle(142)
    }, t.geoStereographicRaw = Nh, t.geoStream = Ic, t.geoTransform = function(t) {
        return {
            stream: Vl(t)
        }
    ...
    }, t.geoTransverseMercatorRaw = Ch, t.gray = function(t, n) {
    ...
    }, t.hcl = ze, t.hierarchy = Rh, t.histogram = N, t.hsl = pe, t.html = Su, t.image = function(t, n) {
    ...
    }, t.interpolate = dr, t.interpolateArray = function(t, n) {
        return (or(n) ? ir : ar)(t, n)
    }, t.interpolateBasis = Ve, t.interpolateBasisClosed = $e, t.interpolateBlues = M_, t.interpolateBrBG = Rv, t.interpolateBuGn = Jv, t.interpolateBuPu = n_, t.interpolateCividis = function(t) {
    ...
    }, t.interpolateCool = F_, t.interpolateCubehelix = Pr, t.interpolateCubehelixDefault = q_, t.interpolateCubehelixLong = zr, t.interpolateDate = ur, t.interpolateDiscrete = function(t) {
        var n = t.length;
        return function(e) {
            return t[Math.max(0, Math.min(n - 1, Math.floor(e * n)))]
        }
    }, t.interpolateGnBu = r_, t.interpolateGreens = T_, t.interpolateGreys = E_, t.interpolateHcl = kr, t.interpolateHclLong = Nr, t.interpolateHsl = Tr, t.interpolateHslLong = Sr, t.interpolateHue = function(t, n) {
        var e = Ke(+t, +n);
        return function(t) {
            var n = e(t);
            return n - 360 * Math.floor(n / 360)
        }
    }, t.interpolateInferno = H_, t.interpolateLab = function(t, n) {
    ...
    }, t.interpolateRdBu = jv, t.interpolateRdGy = Xv, t.interpolateRdPu = d_, t.interpolateRdYlBu = Vv, t.interpolateRdYlGn = Wv, t.interpolateReds = P_, t.interpolateRgb = tr, t.interpolateRgbBasis = er, t.interpolateRgbBasisClosed = rr, t.interpolateRound = pr, t.interpolateSinebow = function(t) {
        var n;
        return t = (.5 - t) * Math.PI, U_.r = 255 * (n = Math.sin(t)) * n, U_.g = 255 * (n = Math.sin(t + I_)) * n, U_.b = 255 * (n = Math.sin(t + B_)) * n, U_ + ""
    }, t.interpolateSpectral = Kv, t.interpolateString = hr, t.interpolateTransformCss = mr, t.interpolateTransformSvg = xr, t.interpolateTurbo = function(t) {
    ...
    }, t.interpolateViridis = L_, t.interpolateWarm = R_, t.interpolateYlGn = v_, t.interpolateYlGnBu = g_, t.interpolateYlOrBr = b_, t.interpolateYlOrRd = x_, t.interpolateZoom = Mr, t.interrupt = oi, t.intersection = function(t, ...n) {
        ...
        return null == n ? (r.restart(t, n, e), r) : (r._restart = r.restart, r.restart = function(t, n, e) {
            n = +n, e = null == e ? Hr() : +e, r._restart((function o(a) {
                a += i, r._restart(o, i += n, e), t(a)
            }), n, e)
        }, r.restart(t, n, e), r)
    }, t.isoFormat = av, t.isoParse = uv, t.json = function(t, n) {
        return fetch(t, n).then(Mu)
    }, t.lab = Te, t.lch = function(t, n, e, r) {
        return 1 === arguments.length ? Pe(t) : new De(e, n, t, null == r ? 1 : r)
        ...
        if (1 === e.length) {
            ...
            for (const n of t)(i ? e(n, r) < 0 : 0 === e(n, n)) && (r = n, i = !0);
        return r
    }, t.leastIndex = Y, t.line = bb, t.lineRadial = Eb, t.linkHorizontal = function() {
        return zb(Db)
    ...
    }, t.matcher = mt, t.max = C, t.maxIndex = F, t.mean = function(t, n) {
        let e = 0,
            r = 0;
        if (void 0 === n)
        ...
        return q(t, .5, n)
    }, t.merge = O, t.min = P, t.minIndex = U, t.namespace = lt, t.namespaces = st, t.nice = E, t.now = Hr, t.pack = function() {
        var t = null,
            n = 1,
            e = 1,
            r = ed;
        function i(i) {
            return i.x = n / 2, i.y = e / 2, t ? i.eachBefore(od(t)).eachAfter(ad(r, .5)).eachBefore(ud(1)) : i.eachBefore(od(id)).eachAfter(ad(ed, 1)).eachAfter(ad(r, i.r / Math.min(n, e))).eachBefore(ud(Math.min(n, e) / (2 * i.r))), i
        }
        return i.radius = function(n) {
            ...
            return arguments.length ? (r = "function" == typeof t ? t : rd(+t), i) : r
        }, i
    }, t.packEnclose = Yh, t.packSiblings = function(t) {
        return Jh(t), t
    ...
    }, t.path = Jo, t.permute = function(t, n) {
        ...
        return a.value = function(n) {
            ...
            return arguments.length ? (o = "function" == typeof t ? t : G_(+t), a) : o
        }, a
    }, t.piecewise = Dr, t.pointRadial = Nb, t.pointer = kn, t.pointers = function(t, n) {
        return t.target && (t = En(t), void 0 === n && (n = t.currentTarget), t = t.touches || [t]), Array.from(t, t => kn(t, n))
        ...
        return c
    }, t.precisionFixed = ac, t.precisionPrefix = uc, t.precisionRound = cc, t.quadtree = zu, t.quantile = q, t.quantileSorted = R, t.quantize = function(t, n) {
        for (var e = new Array(n), r = 0; r < n; ++r) e[r] = t(r / (n - 1));
        return e
    }, t.quickselect = z, t.radialArea = kb, t.radialLine = Eb, t.randomBates = qd, t.randomBernoulli = Od, t.randomBeta = Bd, t.randomBinomial = Yd, t.randomCauchy = jd, t.randomExponential = Rd, t.randomGamma = Id, t.randomGeometric = Ud, t.randomInt = Cd, t.randomIrwinHall = Dd, t.randomLcg = function(t = Math.random()) {
        let n = 0 | (0 <= t && t < 1 ? t / Gd : Math.abs(t));
        return () => (n = 1664525 * n + 1013904223 | 0, Gd * (n >>> 0))
    }, t.randomLogNormal = zd, t.randomLogistic = Hd, t.randomNormal = Pd, t.randomPareto = Fd, t.randomPoisson = Xd, t.randomUniform = Nd, t.randomWeibull = Ld, t.range = B, t.reduce = function(t, n, e) {
    ...
    }, t.scaleBand = Kd, t.scaleDiverging = function t() {
        var n = fp(mv()(np));
        return n.copy = function() {
            return _v(n, t())
        }, $d.apply(n, arguments)
    }, t.scaleDivergingLog = function t() {
        var n = vp(mv()).domain([.1, 1, 10]);
        return n.copy = function() {
            return _v(n, t()).base(n.base())
        }, $d.apply(n, arguments)
    }, t.scaleDivergingPow = xv, t.scaleDivergingSqrt = function() {
        return xv.apply(null, arguments).exponent(.5)
        ...
        }, n = arguments.length ? Array.from(n, Jd) : [0, 1], fp(r)
    }, t.scaleImplicit = Wd, t.scaleLinear = function t() {
        var n = up();
        return n.copy = function() {
            return op(n, t())
        }, Vd.apply(n, arguments), fp(n)
    }, t.scaleLog = function t() {
        var n = vp(ap()).domain([1, 10]);
        return n.copy = function() {
            return op(n, t()).base(n.base())
        }, Vd.apply(n, arguments), n
    }, t.scaleOrdinal = Zd, t.scalePoint = function() {
        return Qd(Kd.apply(null, arguments).paddingInner(1))
    }, t.scalePow = Tp, t.scaleQuantile = function t() {
        var e, r = [],
            i = [],
            a = [];
        function u() {
        ...
        return o.invert = function(t) {
            ...
            return arguments.length ? (e.range((r = Array.from(t, Jd)).map(Sp)), o) : r.slice()
    ...
    }, t.scaleSequentialPow = bv, t.scaleSequentialQuantile = function t() {
        var e = [],
            r = np;
        function i(t) {
        ...
        return bv.apply(null, arguments).exponent(.5)
        ...
        return Tp.apply(null, arguments).exponent(.5)
        ...
        return Vd.apply(yv(fg, ug, Vp, Hp, Lp, Bp, Up, Pp, t.timeFormat).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments)
    }, t.scaleUtc = function() {
        return Vd.apply(yv(qg, zg, _g, gg, dg, lg, Up, Pp, t.utcFormat).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]), arguments)
    }, t.scan = function(t, n) {
        const e = Y(t, n);
        return e < 0 ? void 0 : e
    }, t.schemeAccent = Av, t.schemeBlues = w_, t.schemeBrBG = qv, t.schemeBuGn = Qv, t.schemeBuPu = t_, t.schemeCategory10 = Mv, t.schemeDark2 = Tv, t.schemeGnBu = e_, t.schemeGreens = A_, t.schemeGreys = S_, t.schemeOrRd = i_, t.schemeOranges = z_, t.schemePRGn = Fv, t.schemePaired = Sv, t.schemePastel1 = Ev, t.schemePastel2 = kv, t.schemePiYG = Uv, t.schemePuBu = c_, t.schemePuBuGn = a_, t.schemePuOr = Bv, t.schemePuRd = s_, t.schemePurples = k_, t.schemeRdBu = Lv, t.schemeRdGy = Hv, t.schemeRdPu = h_, t.schemeRdYlBu = Gv, t.schemeRdYlGn = $v, t.schemeReds = C_, t.schemeSet1 = Nv, t.schemeSet2 = Cv, t.schemeSet3 = Pv, t.schemeSpectral = Zv, t.schemeTableau10 = zv, t.schemeYlGn = y_, t.schemeYlGnBu = p_, t.schemeYlOrBr = __, t.schemeYlOrRd = m_, t.select = Mn, t.selectAll = function(t) {
        return "string" == typeof t ? new xn([document.querySelectorAll(t)], [document.documentElement]) : new xn([null == t ? [] : vt(t)], mn)
    }, t.selection = wn, t.selector = yt, t.selectorAll = bt, t.shuffle = L, t.shuffler = j, t.some = function(t, n) {
        if ("function" != typeof n) throw new TypeError("test is not a function");
        let e = -1;
        for (const r of t)
            if (n(r, ++e, t)) return !0;
        ...
        return i.keys = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : G_(Array.from(n)), i) : t
        }, i.value = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : G_(+t), i) : r
        }, i.order = function(t) {
            return arguments.length ? (n = null == t ? Dm : "function" == typeof t ? t : G_(Array.from(t)), i) : n
        }, i.offset = function(t) {
    ...
    }, t.stackOrderAppearance = Fm, t.stackOrderAscending = Um, t.stackOrderDescending = function(t) {
        return Um(t).reverse()
    ...
    }, t.stackOrderNone = Dm, t.stackOrderReverse = function(t) {
        return Dm(t).reverse()
    }, t.stratify = function() {
        var t = hd,
            n = dd;
        function e(e) {
            ...
            if (o.parent = sd, o.eachBefore((function(t) {
                    t.depth = t.parent.depth + 1, --l
                })).eachBefore(Ih), o.parent = null, l > 0) throw new Error("cycle");
            return o
        }
        ...
        function r() {
            var r;
            if (e || (e = r = Jo()), t.apply(this, arguments).draw(e, +n.apply(this, arguments)), r) return e = null, r + "" || null
        }
        return t = "function" == typeof t ? t : G_(t || Fb), n = "function" == typeof n ? n : G_(void 0 === n ? 64 : +n), r.type = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : G_(n), r) : t
        }, r.size = function(t) {
            return arguments.length ? (n = "function" == typeof t ? t : G_(+t), r) : n
        }, r.context = function(t) {
            return arguments.length ? (e = null == t ? null : t, r) : e
        }, r
    }, t.symbolCircle = Fb, t.symbolCross = Ob, t.symbolDiamond = Bb, t.symbolSquare = Xb, t.symbolStar = Hb, t.symbolTriangle = Vb, t.symbolWye = Qb, t.symbols = Jb, t.text = bu, t.thresholdFreedmanDiaconis = function(t, n, e) {
    ...
    }, t.thresholdSturges = k, t.tickFormat = cp, t.tickIncrement = T, t.tickStep = S, t.ticks = A, t.timeDay = Hp, t.timeDays = Xp, t.timeFormatDefaultLocale = iv, t.timeFormatLocale = Ig, t.timeFriday = Qp, t.timeFridays = og, t.timeHour = Lp, t.timeHours = jp, t.timeInterval = Cp, t.timeMillisecond = Pp, t.timeMilliseconds = zp, t.timeMinute = Bp, t.timeMinutes = Yp, t.timeMonday = $p, t.timeMondays = ng, t.timeMonth = ug, t.timeMonths = cg, t.timeSaturday = Jp, t.timeSaturdays = ag, t.timeSecond = Up, t.timeSeconds = Ip, t.timeSunday = Vp, t.timeSundays = tg, t.timeThursday = Kp, t.timeThursdays = ig, t.timeTuesday = Wp, t.timeTuesdays = eg, t.timeWednesday = Zp, t.timeWednesdays = rg, t.timeWeek = Vp, t.timeWeeks = tg, t.timeYear = fg, t.timeYears = sg, t.timeout = Qr, t.timer = Vr, t.timerFlush = $r, t.transition = qi, t.transpose = H, t.tree = function() {
        var t = pd,
            n = 1,
            e = 1,
            r = null;
        ...
        return s.round = function(t) {
            ...
            return arguments.length ? (o = "function" == typeof t ? t : rd(+t), s) : o
            ...
            return arguments.length ? (a = "function" == typeof t ? t : rd(+t), s) : a
        }, s.paddingRight = function(t) {
            return arguments.length ? (u = "function" == typeof t ? t : rd(+t), s) : u
        }, s.paddingBottom = function(t) {
            return arguments.length ? (c = "function" == typeof t ? t : rd(+t), s) : c
        }, s.paddingLeft = function(t) {
            return arguments.length ? (f = "function" == typeof t ? t : rd(+t), s) : f
        }, s
        ...
        var t, n, e, r = Vm,
            ...
            g = 10;
        function y(t) {
            t.property("__zoom", Wm).on("wheel.zoom", M).on("mousedown.zoom", A).on("dblclick.zoom", T).filter(u).on("touchstart.zoom", S).on("touchmove.zoom", E).on("touchend.zoom touchcancel.zoom", k).style("-webkit-tap-highlight-color", "rgba(0,0,0,0)")
        }
        function v(t, n) {
            return (n = Math.max(c[0], Math.min(c[1], n))) === t.k ? t : new Lm(n, t.x, t.y)
        }
        function _(t, n, e) {
            var r = n[0] - e[0] * t.k,
                i = n[1] - e[1] * t.k;
        ...
        function A(t, ...n) {
            ...
            function d(t) {
                a.on("mousemove.zoom mouseup.zoom", null), zn(t.view, i.moved), Gm(t), i.event(t).end()
            }
        }
        function T(t, ...n) {
            if (r.apply(this, arguments)) {
        ...
        function k(t, ...r) {
            if (this.__zooming) {
                var i, o, a = x(this, r).event(t),
                    u = t.changedTouches,
                    c = u.length;
                for (Xm(t), e && clearTimeout(e), e = setTimeout((function() {
                        e = null
        ...
        return y.transform = function(t, n, e, r) {
            ...
            i.property("__zoom", Wm), t !== i ? m(t, n, e, r) : i.interrupt().each((function() {
            ...
            return arguments.length ? (a = "function" == typeof t ? t : Bm(+t), y) : a
        }, y.filter = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : Bm(!!t), y) : r
        }, y.touchable = function(t) {
            return arguments.length ? (u = "function" == typeof t ? t : Bm(!!t), y) : u
        }, y.extent = function(t) {
    ...
    }, t.zoomIdentity = jm, t.zoomTransform = Hm, Object.defineProperty(t, "__esModule", {
        value: !0
    })
}));